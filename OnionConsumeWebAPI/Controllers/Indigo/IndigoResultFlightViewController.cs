        ...
        public async Task<ActionResult> IndigoTripsell(string fareKey, string journeyKey)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                if (_GetBookingFromStateRS1 != null)
                {
                    ...
                    IndigoBookingManager_.PriceItineraryResponse _getPriceItineraryRS = null;// await objsell.GetItineraryPrice(Signature, journeyKey, fareKey, "", "", TotalCount, adultcount, childcount, infantcount, "OneWay");
                    ...
                    List<IndigoBookingManager_.GetSSRAvailabilityForBookingResponse> _res = await objssr.GetSSRAvailabilityForBooking(Signature, passeengerlist, TotalCount, "OneWay");
