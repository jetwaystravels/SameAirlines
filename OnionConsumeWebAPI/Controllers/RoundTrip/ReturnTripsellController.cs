    ...
    public class ReturnTripsellController : Controller
    {
        ...
        public async Task<IActionResult> ReturnTripsellView(List<string> fareKey, List<string> journeyKey)
        {
            ...
            if (getRadioButton.ToLower() != "roundtrip")
            {
                ...
                //return RedirectToAction("ReturnTripsellView", "ReturnTripsell");
            }
            //end here
            ...
            for (int p = 0; p < 1; p++)
            {
                ...
                else if (fareKey[p].ToLower().Contains("qatar"))
                {
                    flagsession = "H1";
                    airlinename = "qatar";
                }
                else if (fareKey[p].ToLower().Contains("etihad"))
                {
                    flagsession = "H1";
                    airlinename = "etihad";
                }
                else if (fareKey[p].ToLower().Contains("emirates"))
                {
                    flagsession = "H1";
                    airlinename = "emirates";
                }
                else if (fareKey[p].ToLower().Contains("thaiairways"))
                {
                    flagsession = "H1";
                    airlinename = "thaiairways";
                }
                else if (fareKey[p].ToLower().Contains("singaporeairline"))
                {
                    flagsession = "H1";
                    airlinename = "singaporeairline";
                }
                else if (fareKey[p].ToLower().Contains("malaysia"))
                {
                    flagsession = "H1";
                    airlinename = "malaysia";
                }
                else if (fareKey[p].ToLower().Contains("cathaypacific"))
                {
                    flagsession = "H1";
                    airlinename = "cathaypacific";
                }
                else if (fareKey[p].ToLower().Contains("srilankan"))
                {
                    flagsession = "H1";
                ...
                List<string> _JourneykeyDataSameRT = new List<string>();
                List<string> _FareKeyDataSameRT = new List<string>();
                ...
                using (HttpClient client = new HttpClient())
                {
                    if (_JourneykeyRTData.ToLower() == "airasia")
                    {
                        ...
                        string JourneyKeyOneway = string.Empty;
                        string fareKeyKeyOneway = string.Empty;
                        string[] Jparts = null;
                        string[] Fparts = null;

                        for (int i = 0; i < journeyKey.Count; i++)
                        {
                            key = new _Key();
                            JourneyKeyOneway = journeyKey[i];
                        ...
                        if (responseTripsell.IsSuccessStatusCode)
                        {
                            ...
                            if (infanttype != null && infanttype != "")
                            {
                                ...
                                for (int kj = 0; kj < passeengerKeyListinfant.journeys.Count; kj++)
                                {
                                    //for (int k1 = 0; k1 < passeengerKeyListinfant.journeys[kj].segments.Count; k1++)
                                    //{
                                    ...
                                    identifier1.identifier = passeengerKeyListinfant.journeys[kj].segments[0].identifier.identifier;
                                    identifier1.carrierCode = passeengerKeyListinfant.journeys[kj].segments[0].identifier.carrierCode;
                                    marketobj.identifier = identifier1;
                                    marketobj.destination = passeengerKeyListinfant.journeys[kj].segments[0].designator.destination;
                                    marketobj.origin = passeengerKeyListinfant.journeys[kj].segments[0].designator.origin;
                                    ...
                                    for (int i = 0; i < typecount; i++)
                                    {
                                        ...
                                        if (infant == "INFT")
                                        {
                                            ...
                                            for (int j = 0; j < infantCount1; j++)
                                            {
                                                ...
                                                designatorr.destination = passeengerKeyListinfant.journeys[kj].segments[0].designator.destination;
                                                designatorr.origin = passeengerKeyListinfant.journeys[kj].segments[0].designator.origin;
                                                if (kj == 1)
                                                {
                                                    designatorr.departureDate = _SimpleAvailabilityobject.endDate;
                                                }
                                                else
                                                {
                                    ...
                                    Key Keyobj = new Key();
                                    //Keyobj.journeyKey = journeyKey[kj];
                                    //Keyobj.fareAvailabilityKey = fareKey[kj];
                                    JourneyKeyOneway = journeyKey[kj];
                                    Jparts = JourneyKeyOneway.Split('@');
                                    _JourneykeyData = Jparts[0];
                                    Keyobj.journeyKey = _JourneykeyData;


                                    fareKeyKeyOneway = fareKey[kj];
                                    Fparts = fareKeyKeyOneway.Split('@');
                                    _FareKeyData = Fparts[0];
                                ...
                                logs.WriteLogsR(jsonPassengers, "4-GetItenaryReq", "SameAirAsiaRT");
                                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                                client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
                                ...
                                if (responsePassengers.IsSuccessStatusCode)
                                {
                                    ...
                                    logs.WriteLogsR(_responsePassengers, "4-GetItenaryRes", "SameAirAsiaRT");
                                    ...
                                    int Infantbase = JsonObjPassengers.data.breakdown.passengerTotals.infant.total;
                                    int Infanttax = JsonObjPassengers.data.breakdown.passengerTotals.infant.taxes;
                                    int Inftcount = 0;
                                    ...
                                    for (int i = 0; i < Journeyscount; i++)
                                    {
                                        ...
                                        for (int j = 0; j < Segmentscount; j++)
                                        {
                                            ...
                                            for (int k = 0; k < FareCount; k++)
                                            {
                                                ...
                                                foreach (var items in JsonObjPassengers.data.passengers)
                                                {
                                                    ...
                                                    if (passkeytypeobject.passengerTypeCode != "CHD")
                                                    {
                                                        ...
                                                        if (JsonObjPassengers.data.passengers[passkeytypeobject.passengerKey].infant != null)
                                                        {
                                                            ...
                                                            //// x.data.passengers["MCFBRFQ-"].infant.fees[0].serviceCharges
                                                            //int _infantAmount = 0;
                                                            //for (int a = 1; a < Inftaxcount; a++)
                                                            //{
                                                            //    int infamount = JsonObjPassengers.data.passengers[passkeytypeobject.passengerKey].infant.fees[0].serviceCharges[a].amount;
                                                            //    _infantAmount += infamount;
                                                            //    inftax += infamount;
                                                            //}

                                                            //                   int _Inftbasefare = JsonObjPassengers.data.passengers[passkeytypeobject.passengerKey].infant.fees[0].serviceCharges[0].amount;
                                                            //                    Inftbasefare += _Inftbasefare - _infantAmount;
                                                            //                    List<DomainLayer.Model.Fee> feeList = new List<DomainLayer.Model.Fee>();
                                                            //                    for (int i1 = 0; i1 < Feecount; i1++)
                                                            //                    {
                                                            ...
                                                            //                        feeobject.code = JsonObjPassengers.data.passengers[passkeytypeobject.passengerKey].infant.fees[i1].code;
                                                            ...
                                                            //                        var serviceChargesCount = JsonObjPassengers.data.passengers[passkeytypeobject.passengerKey].infant.fees[i1].serviceCharges.Count;
                                                            //                        servicechargeInfantobj.amount = JsonObjPassengers.data.passengers[passkeytypeobject.passengerKey].infant.fees[i1].serviceCharges[0].amount;
                                                ...
                                                AirAsiaTripResponceobject.inftbasefare = Infantbase / Inftcount;
                                                AirAsiaTripResponceobject.basefaretax = Infanttax;
                    ...
                    if (_JourneykeyRTData.ToLower() == "spicejet")
                    {
                        ...
                        {
                            if (journeyKey.Count > 0)
                            {
                                _JourneykeyData = journeyKey[i].Split('@')[0].ToString();

                            }
                            if (fareKey.Count > 0)
                            {
                                _FareKeyData = fareKey[i].Split('@')[0].ToString();

                            }
                            _getSellRQ.SellRequestData.SellJourneyByKeyRequest.SellJourneyByKeyRequestData.JourneySellKeys[i] = new SellKeyList();
                            _getSellRQ.SellRequestData.SellJourneyByKeyRequest.SellJourneyByKeyRequestData.JourneySellKeys[i].JourneySellKey = _JourneykeyData;
                            _getSellRQ.SellRequestData.SellJourneyByKeyRequest.SellJourneyByKeyRequestData.JourneySellKeys[i].FareSellKey = _FareKeyData;
                        ...
                        if (_GetBookingFromStateRS1 != null)
                        {
                            ...
                            {
                                for (int a1 = 0; a1 < AAJourneyList.Count; a1++)
                                {

                                    for (int i = 0; i < AAJourneyList[a1].segments.Count; i++)
                                    {
                                        for (int k = 0; k < AAJourneyList[a1].segments[i].fares.Count; k++)
                                        {
                                            for (int l = 0; l < AAJourneyList[a1].segments[i].fares[k].passengerFares.Count; l++)
                                            {
                                                if (AAJourneyList[a1].segments[i].fares[k].passengerFares[l].passengerType == "ADT")
                                                {
                                                    for (int i2 = 0; i2 < AAJourneyList[a1].segments[i].fares[k].passengerFares[l].serviceCharges.Count; i2++)
                                                    {
                                                        if (i2 == 0)
                                                        {
                                                            continue;
                                                        ...
                                                        {
                                                            Adulttax += AAJourneyList[a1].segments[i].fares[k].passengerFares[l].serviceCharges[i2].amount;
                                                        }
                                                    }
                                                }
                                                if (AAJourneyList[a1].segments[i].fares[k].passengerFares[l].passengerType == "CHD")
                                                {
                                                    for (int i2 = 0; i2 < AAJourneyList[a1].segments[i].fares[k].passengerFares[l].serviceCharges.Count; i2++)
                                                    {
                                                        if (i2 == 0)
                                                        ...
                                                        {
                                                            childtax += AAJourneyList[a1].segments[i].fares[k].passengerFares[l].serviceCharges[i2].amount;
                                                        }
                                                    }
                                                }
                                            }
                            ...
                            for (int i = 0; i < _getPriceItineraryRQ.ItineraryPriceRequest.SellByKeyRequest.JourneySellKeys.Length; i++)
                            {
                                if (journeyKey.Count > 0)
                                {
                                    _getSellKeyList.JourneySellKey = journeyKey[i].ToString().Split('@')[0];
                                }

                                if (fareKey.Count > 0)
                                {
                                    _getSellKeyList.FareSellKey = fareKey[i].ToString().Split('@')[0];
                                }
                            ...
                            var jsonData = HttpContext.Session.GetString("SpicejetAvailibilityRequest");
                            ...
                            if (_GetBookingFromStateRS != null)
                            {
                                ...
                                if (_GetBookingFromStateRS.BookingData.Passengers.Length > 0 && _GetBookingFromStateRS.BookingData.Passengers[0].PassengerFees.Length > 0)
                                {
                                    ...
                                    for (int i1 = 0; i1 < _GetBookingFromStateRS.BookingData.Passengers[0].PassengerFees.Length; i1++)
                                    {

                                        for (int i = 0; i < _GetBookingFromStateRS.BookingData.Passengers[0].PassengerFees[i1].ServiceCharges.Length; i++)
                                        {
                                            if (i == 0)
                                            {
                                                Inftbasefare = Convert.ToInt32(_GetBookingFromStateRS.BookingData.Passengers[0].PassengerFees[i1].ServiceCharges[0].Amount);
                                                Inftcount += Convert.ToInt32(_GetBookingFromStateRS.BookingData.Passengers.Length);
                                                AirAsiaTripResponceobj.inftcount = Inftcount;
                                                AirAsiaTripResponceobj.inftbasefare += Inftbasefare;
                                            }
                                            ...
                                            {
                                                infttax += Convert.ToInt32(_GetBookingFromStateRS.BookingData.Passengers[0].PassengerFees[i1].ServiceCharges[i].Amount);
                                            }
                    ...
                    if (_JourneykeyRTData.ToLower() == "indigo")
                    {
                        ...
                        int infantcount = Convert.ToInt32(HttpContext.Session.GetString("infantCount"));
                        TotalCount = adultcount + childcount;
                        _JourneykeyDataSameRT = journeyKey;
                        _FareKeyDataSameRT = fareKey;
                        _JourneykeyData = _Jparts[0];
                        string fareKeyRTway = fareKey[p];
                        string[] FRTparts = fareKeyRTway.Split('@');
                        _FareKeyData = FRTparts[0];
                        ...
                        IndigoBookingManager_.SellResponse _getSellRS = await objsell.Sell(Signature, _JourneykeyDataSameRT, _FareKeyDataSameRT, _Jparts[0], fareKey[p], TotalCount, adultcount, childcount, infantcount);
                        #endregion
                        #region GetState
                        ...
                        if (_GetBookingFromStateRS1 != null)
                        {
                            ...
                            IndigoBookingManager_.PriceItineraryResponse _getPriceItineraryRS = await objsell.GetItineraryPrice(Signature, _JourneykeyDataSameRT, _FareKeyDataSameRT, _Jparts[0], fareKey[p], TotalCount, adultcount, childcount, infantcount);
                            #endregion
                            HttpContext.Session.SetString("journeySellKey", JsonConvert.SerializeObject(_JourneykeyData));
                            SimpleAvailabilityRequestModel _SimpleAvailabilityobj = new SimpleAvailabilityRequestModel();
                            ...
                            for (int i = 0; i < journeyscount; i++)
                            {
                                ...
                                for (int j = 0; j < segmentscount; j++)
                                {
                                    ...
                                    if (getAirPriceRes[0].Bonds[0].Legs[0].AirlineName == "UK")
                                        ...
                                        getAirPriceRes[0].Bonds[0].Legs[0].AirlineName = "Emirates";
                                    else if (getAirPriceRes[0].Bonds[0].Legs[0].AirlineName == "EY")
                                        getAirPriceRes[0].Bonds[0].Legs[0].AirlineName = "Etihad";
                                    else if (getAirPriceRes[0].Bonds[0].Legs[0].AirlineName == "CX")
                                        getAirPriceRes[0].Bonds[0].Legs[0].AirlineName = "CathayPacific";
                                    else if (getAirPriceRes[0].Bonds[0].Legs[0].AirlineName == "SQ")
                                        getAirPriceRes[0].Bonds[0].Legs[0].AirlineName = "SingaporeAirline";
                                    else if (getAirPriceRes[0].Bonds[0].Legs[0].AirlineName == "MH")
                                        getAirPriceRes[0].Bonds[0].Legs[0].AirlineName = "Malaysia";
                                    else if (getAirPriceRes[0].Bonds[0].Legs[0].AirlineName == "UL")
                                        getAirPriceRes[0].Bonds[0].Legs[0].AirlineName = "SriLankan";
                                    else if (getAirPriceRes[0].Bonds[0].Legs[0].AirlineName == "OD")
                                        getAirPriceRes[0].Bonds[0].Legs[0].AirlineName = "Batik";
                                    else if (getAirPriceRes[0].Bonds[0].Legs[0].AirlineName == "WY")
                                        getAirPriceRes[0].Bonds[0].Legs[0].AirlineName = "Oman Air";
                    ...
                    if (_JourneykeyRTData.ToLower() == "airasia")
                    {
                        ...
                        //Start :round trip
                        string Journeykeyairasia = string.Empty;
                        List<data> datalist = new List<data>();
                        SeatMapResponceModel SeatMapResponceModel = null;
                        for (int i = 0; i < journeyKey.Count; i++)
                        {
                            Journeykeyairasia = journeyKey[i];
                            ...
                            int index = Journeykeyairasia.IndexOf('@');
                            ...
                            if (responseSeatmap.IsSuccessStatusCode)
                            {
                                ...
                                foreach (Match mitem in Regex.Matches(_responseSeatmap, @"seatMap"":[\s\S]*?ssrLookup", RegexOptions.IgnoreCase | RegexOptions.Multiline))
                                {
                                    try
                                    {
                                        ...
                                        // dataobj.JourneyIndex = SeatGroup[x].SeatAvailabilityResponse.OtherServiceInfoList[0].Text;
                                        string journeyside = i.ToString() + x.ToString();
                                        dataobj.JourneyIndex = journeyside;
                        ...
                        if (AirAsiaTripResponceobj.journeys.Count > 0)
                        {
                            for (int a = 0; a < AirAsiaTripResponceobj.journeys.Count; a++)
                            {
                                ...
                                for (int i = 0; i < AirAsiaTripResponceobj.journeys[a].segments.Count; i++)
                                {
                                    ...
                                    _getSeatAvailabilityResponse = await objSpiceJet.GetseatAvaialbility(_getseatAvailabilityRequest, a, i);
                    ...
                    if (_JourneykeyRTData.ToLower() == "airasia")
                    {
                        ...
                        int journeycount = passeengerKeyList.journeys.Count;
                        ...
                        Hashtable htjourneyindex = new Hashtable();
                        List<Trip> Tripslist = new List<Trip>();
                        for (int i = 0; i < passeengerKeyList.journeys.Count; i++)
                        {
                            for (int j = 0; j < passeengerKeyList.journeys[i].segments.Count; j++)
                            {
                                for (int k = 0; k < passeengerKeyList.journeys[i].segments[j].legs.Count; k++)
                                {


                                    Trip Tripobj = new Trip();
                                    //Tripobj.origin = passeengerKeyList.journeys[0].designator.origin;
                                    Tripobj.origin = passeengerKeyList.journeys[i].segments[j].legs[k].designator.origin;
                                    Tripobj.destination = passeengerKeyList.journeys[i].segments[j].legs[k].designator.destination;
                                    Tripobj.departureDate = passeengerKeyList.journeys[i].segments[j].designator.departure.ToString();
                                    ...
                                    TripIdentifierobj.carrierCode = passeengerKeyList.journeys[i].segments[j].identifier.carrierCode;
                                    //_Identifier.carrierCode = "I5";
                                    TripIdentifierobj.identifier = passeengerKeyList.journeys[i].segments[j].identifier.identifier;
                                    TripIdentifierlist.Add(TripIdentifierobj);
                                    Tripobj.identifier = TripIdentifierlist;
                                    Tripslist.Add(Tripobj);
                                    htjourneyindex.Add(Tripobj.origin + "_" + Tripobj.destination, i.ToString() + j.ToString());
                                }
                            }
                        }
                        ...
                        if (responseSSRAvailabilty.IsSuccessStatusCode)
                        {
                            ...
                            //int journeySSrcount = JsonObjresponseSSRAvailabilty.data.journeySsrs.count();
                            ...
                            //   string[] values = { "00", "01", "10", "11" };

                            //for (int jc = 0; jc < journeycount; jc++)
                            //{
                            ...
                            for (int i = 0; i < legSsrscount; i++)
                            {
                                ...
                                if (htjourneyindex[legDetailsobj.origin + "_" + legDetailsobj.destination] != null)
                                {
                                    SSRAvailabiltyLegssrobj.Journeyorder = htjourneyindex[legDetailsobj.origin + "_" + legDetailsobj.destination].ToString();
                                }
                                //SSRAvailabiltyLegssrobj.Journeyorder = values[i];
                    ...
                    if (_JourneykeyRTData.ToLower() == "akasaair")
                    {
                        ...
                        var jsonSSRAvailabiltyRequest = JsonConvert.SerializeObject(_SSRAvailabilty, Formatting.Indented);
                        logs.WriteLogsR("Request:" + jsonSSRAvailabiltyRequest , "8-SSR_Availability", "SameAkasaRT");
                        SSRAvailabiltyResponceModel SSRAvailabiltyResponceobj = new SSRAvailabiltyResponceModel();
                        client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
                        client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", token);
                        ...
                        {
                            var _responseSSRAvailabilty = responseSSRAvailabilty.Content.ReadAsStringAsync().Result;
                            logs.WriteLogsR("Url: " + AppUrlConstant.URLAkasaAir + "/api/nsk/v2/booking/ssrs/availability" + "\n Response: " + _responseSSRAvailabilty, "8-SSR_Availability", "SameAkasaRT");
                    ...
                    if (_JourneykeyRTData.ToLower() == "spicejet")
                    {
                        ...
                        //availibiltyRQ
                        List<GetSSRAvailabilityForBookingResponse> SSRGroup = new List<GetSSRAvailabilityForBookingResponse>();
                        ...
                        try
                        {
                            ...
                            for (int i = 0; i < journeyscount; i++)
                            {
                                ...
                                objSpiceJet = new SpiceJetApiController();
                                //_res = await objSpiceJet.GetMealAvailabilityForBooking(_req);
                            ...
                            if (SSRGroup != null)
                            {
                                ...
                                try
                                {
                                    ...
                                    List<childlegssrs> legssrslist = new List<childlegssrs>();
                                    for (int i = 0; i < SSRGroup.Count; i++)
                                    {
                                        for (int i1 = 0; i1 < SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList.Length; i1++)
                                        {
                                            legssrslist = new List<childlegssrs>();
                                            for (int j = 0; j < SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList.Length; j++)
                                            {
                                                //if (_res.SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].InventoryControlled == true)
                                                //{
                                                int legSsrscount = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].SSRLegList.Length;
                                                try
                                                {
                                                    //for (int i = 0; i < legSsrscount; i++)
                                                    //{
                                                    ...
                                                    SSRAvailabiltyLegssrobj.legKey = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.ToString();
                                                    legDetailsobj = new legDetails();
                                                    legDetailsobj.destination = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.ArrivalStation;
                                                    legDetailsobj.origin = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.DepartureStation;
                                                    legDetailsobj.departureDate = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.DepartureDate.ToString();
                                                    legidentifier legidentifierobj = new legidentifier();
                                                    legidentifierobj.identifier = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.FlightNumber;
                                                    legidentifierobj.carrierCode = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.CarrierCode;
                                                    legDetailsobj.legidentifier = legidentifierobj;
                                                    childlegssrs legssrs = new childlegssrs();
                                                    legssrs.ssrCode = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].SSRCode.ToString();
                                                    ...
                                                    legssrs.ssrCode = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].SSRCode.ToString();
                                                    legssrs.available = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].Available;
                                                    if (SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].PaxSSRPriceList.Length > 0)
                                                    {
                                                        legssrs.feeCode = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].PaxSSRPriceList[0].PaxFee.FeeCode;
                                                        List<legpassengers> legpassengerslist = new List<legpassengers>();
                                                        decimal Amount = decimal.Zero;
                                                        legpassengers passengersdetail = new legpassengers();
                                                        int i2 = 0;
                                                        foreach (var items in SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].PaxSSRPriceList[0].PaxFee.ServiceCharges)
                                                        {
                                                            if (i2 > 0)
                                                            {
                                                                break;
                                                        ...
                                                        passengersdetail.passengerKey = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].PaxSSRPriceList[0].PassengerNumberList.ToString();
                                                        passengersdetail.ssrKey = SSRGroup[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].SSRCode;
                                            ...
                                            SSRAvailabiltyLegssrobj.Journeyorder = i.ToString() + i1.ToString();
                                            SSRAvailabiltyLegssrobj.legDetails = legDetailsobj;
                                            SSRAvailabiltyLegssrobj.legssrs = legssrslist;
                                            SSRAvailabiltyLegssrlist.Add(SSRAvailabiltyLegssrobj);
                                        }
                    ...
                    if (_JourneykeyRTData.ToLower() == "indigo")
                    {
                        ...
                        passeengerlist = (AirAsiaTripResponceModel)JsonConvert.DeserializeObject(passenger, typeof(AirAsiaTripResponceModel));
                        _GetSSR objssr = new _GetSSR();
                        List<IndigoBookingManager_.GetSSRAvailabilityForBookingResponse> _res = await objssr.GetSSRAvailabilityForBooking(Signature, passeengerlist, TotalCount);
                        if (_res != null)
                        {
                            Hashtable htSSr = new Hashtable();
                            ...
                            try
                            {
                                ...
                                {
                                    for (int i1 = 0; i1 < _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList.Length; i1++)
                                    {
                                        legssrslist = new List<childlegssrs>();
                                        for (int j = 0; j < _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList.Length; j++)
                                        {
                                            //if (_res.SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].InventoryControlled == true)
                                            //{
                                            int legSsrscount = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].SSRLegList.Length;
                                            try
                                            {
                                                //for (int i = 0; i < legSsrscount; i++)
                                                //{
                                                SSRAvailabiltyLegssrobj = new legSsrs();
                                                SSRAvailabiltyLegssrobj.legKey = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.ToString();
                                                legDetailsobj = new legDetails();
                                                legDetailsobj.destination = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.ArrivalStation;
                                                legDetailsobj.origin = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.DepartureStation;
                                                legDetailsobj.departureDate = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.DepartureDate.ToString();
                                                legidentifier legidentifierobj = new legidentifier();
                                                legidentifierobj.identifier = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.FlightNumber;
                                                legidentifierobj.carrierCode = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].LegKey.CarrierCode;
                                                legDetailsobj.legidentifier = legidentifierobj;

                                                childlegssrs legssrs = new childlegssrs();
                                                legssrs.ssrCode = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].SSRCode.ToString();
                                                if (htSSr[legssrs.ssrCode] != null)
                                                {
                                                    legssrs.name = htSSr[legssrs.ssrCode].ToString();
                                                }
                                                ...
                                                legssrs.ssrCode = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].SSRCode.ToString();
                                                legssrs.available = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].Available;
                                                if (_res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].PaxSSRPriceList.Length > 0)
                                                {
                                                    legssrs.feeCode = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].PaxSSRPriceList[0].PaxFee.FeeCode;
                                                    List<legpassengers> legpassengerslist = new List<legpassengers>();
                                                    decimal Amount = decimal.Zero;
                                                    legpassengers passengersdetail = new legpassengers();
                                                    int i2 = 0;
                                                    foreach (var items in _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].PaxSSRPriceList[0].PaxFee.ServiceCharges)
                                                    {
                                                        if (i2 > 0)
                                                        {
                                                            break;
                                                    ...
                                                    passengersdetail.passengerKey = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].PaxSSRPriceList[0].PassengerNumberList.ToString();
                                                    passengersdetail.ssrKey = _res[i].SSRAvailabilityForBookingResponse.SSRSegmentList[i1].AvailablePaxSSRList[j].SSRCode;
